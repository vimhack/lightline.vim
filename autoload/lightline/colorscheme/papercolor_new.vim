" =============================================================================
" Filename: autoload/lightline/colorscheme/papercolor_new.vim
" Colorscheme: https://github.com/NLKNguyen/papercolor-theme
" Author: windvalley
" License: MIT License
" =============================================================================
...
if &background == 'dark'
  ...
  let s:red            = ['#ff5faf', 167]
  let s:green          = ['#afd700', 71]
  let s:yellow         = ['#d7af5f', 214]
  let s:blue           = ['#5fafd7', 69]
  let s:magenta        = ['#af87d7', 90]

  let s:orange         = ['#ff8700', 208]
  let s:xgray1         = ['#262626', 235]
  let s:xgray2         = ['#303030', 240]
  let s:xgray3         = ['#3a3a3a', 242]
  let s:xgray4         = ['#585858', 243]
else
  let s:black          = ['#eeeeee', 255]
  let s:white          = ['#444444', 238]

  let s:red            = ['#d70087', 162]
  let s:green          = ['#5f8700', 71]
  let s:yellow         = ['#d75f00', 166]
  let s:blue           = ['#005faf', 69]
  let s:magenta        = ['#8700af', 90]

  let s:orange         = ['#ff8700', 208]
  let s:xgray1         = ['#e4e4e4', 254]
  let s:xgray2         = ['#d0d0d0', 252]
...
let g:lightline#colorscheme#papercolor_new#palette = lightline#colorscheme#flatten(s:p)

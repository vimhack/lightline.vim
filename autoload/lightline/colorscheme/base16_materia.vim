" =============================================================================
" Filename: autoload/lightline/colorscheme/base16_materia.vim
" Colorscheme: https://github.com/chriskempson/base16-vim/blob/master/colors/base16-materia.vim
" Author: windvalley
" License: MIT License
" =============================================================================

let s:black          = ['#263238', 16]
let s:white          = ['#ffffff', 231]
let s:red            = ['#ec5f67', 167]
let s:green          = ['#8bd649', 71]
let s:yellow         = ['#ffcc00', 214]
let s:blue           = ['#89ddff', 69]
let s:magenta        = ['#82aaff', 90]

let s:orange         = ['#FF8700', 208]
let s:xgray1         = ['#2c393f', 236]
let s:xgray2         = ['#37474f', 240]
let s:xgray3         = ['#646F7c', 244]
let s:xgray4         = ['#707880', 247]

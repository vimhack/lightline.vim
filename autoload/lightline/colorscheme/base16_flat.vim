" =============================================================================
" Filename: autoload/lightline/colorscheme/base16_flat.vim
" Colorscheme: https://github.com/chriskempson/base16-vim/blob/master/colors/base16-flat.vim
" Author: windvalley
" License: MIT License
" =============================================================================

let s:black          = ['#2C3E50', 16]
let s:white          = ['#E0E0E0', 255]
let s:red            = ['#E74C3C', 167]
let s:green          = ['#2ECC71', 71]
let s:yellow         = ['#F1C40F', 214]
let s:blue           = ['#3498DB', 69]
let s:magenta        = ['#9B59B6', 90]

let s:orange         = ['#FF8700', 208]
let s:xgray1         = ['#34495E', 236]
let s:xgray2         = ['#536273', 240]
let s:xgray3         = ['#646F7c', 242]
let s:xgray4         = ['#7F8C8D', 243]

" =============================================================================
" Filename: autoload/lightline/colorscheme/base16_atelierdune.vim
" Colorscheme:
"   https://github.com/chriskempson/base16-vim/blob/master/colors/base16-atelierdune.vim
"   https://github.com/chriskempson/base16-vim/blob/master/colors/base16-atelierdune-light.vim
" Author: windvalley
" License: MIT License
" =============================================================================

let s:red            = ['#d73737', 1]
let s:green          = ['#60ac39', 2]
let s:yellow         = ['#ae9513', 3]
let s:blue           = ['#6684e1', 4]
let s:magenta        = ['#b854d4', 5]

if g:colors_name == 'base16-atelier-dune'
  let s:black          = ['#20201d', 0]
  let s:white          = ['#fefbec', 15]

  let s:orange         = ['#ff8700', 208]
  let s:xgray1         = ['#292824', 236]
  let s:xgray2         = ['#3F3E3A', 8]
  let s:xgray3         = ['#565550', 240]
  let s:xgray4         = ['#7d7a68', 243]
else
  let s:black          = ['#fefbec', 15]
  let s:white          = ['#20201d', 0]

  let s:orange         = ['#ff8700', 208]
  let s:xgray1         = ['#e8e4cf', 254]
  let s:xgray2         = ['#ccc8b3', 253]
  let s:xgray3         = ['#b0ad98', 253]
  let s:xgray4         = ['#a6a28c', 253]
endif
